...
public class PoemsActivity extends AppCompatActivity {
    ...
    private ListViewAdapterPoems adapter;
    private DatabaseHelperPoems databaseHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseHelper = new DatabaseHelperPoems(this);
    ...
    public void reloadingDatabase() {
        ...
        adapter = new ListViewAdapterPoems(this, R.layout.book_item, bookList, databaseHelper);
