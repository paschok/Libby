...
import paulryan.libby.adapters.ListViewAdapterSciFi;
import paulryan.libby.database.DatabaseHelperSciFi;

public class SciFiActivity extends AppCompatActivity {

    private ListView listView;
    private ListViewAdapterSciFi adapter;
    private DatabaseHelperSciFi databaseHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseHelper = new DatabaseHelperSciFi(this);
    ...
    public void reloadingDatabase() {
        ...
        adapter = new ListViewAdapterSciFi(this, R.layout.book_item, bookList, databaseHelper);
        listView.setAdapter(adapter);
    }

    private void addingNewFriendDialog() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(SciFiActivity.this);
