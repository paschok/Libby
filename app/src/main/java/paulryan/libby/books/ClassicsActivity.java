...
import paulryan.libby.adapters.ListViewAdapterClassics;
import paulryan.libby.database.DatabaseHelperClassics;

public class ClassicsActivity extends AppCompatActivity {

    private ListView listView;
    private ListViewAdapterClassics adapter;
    private DatabaseHelperClassics databaseHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseHelper = new DatabaseHelperClassics(this);
    ...
    public void reloadingDatabase() {
        ...
        adapter = new ListViewAdapterClassics(this, R.layout.book_item, bookList, databaseHelper);
