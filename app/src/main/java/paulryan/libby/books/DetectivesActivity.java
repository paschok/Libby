...
import paulryan.libby.adapters.ListViewAdapterDetectives;
import paulryan.libby.database.DatabaseHelperDetectives;

public class DetectivesActivity extends AppCompatActivity {

    private ListView listView;
    private ListViewAdapterDetectives adapter;
    private DatabaseHelperDetectives databaseHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseHelper = new DatabaseHelperDetectives(this);
    ...
    public void reloadingDatabase() {
        ...
        adapter = new ListViewAdapterDetectives(this, R.layout.book_item, bookList, databaseHelper);
        listView.setAdapter(adapter);
    }

    private void addingNewFriendDialog() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(DetectivesActivity.this);
