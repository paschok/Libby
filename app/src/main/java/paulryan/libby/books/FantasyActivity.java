...
import paulryan.libby.adapters.ListViewAdapterFantasy;
import paulryan.libby.database.DatabaseHelperFantasy;

public class FantasyActivity extends AppCompatActivity {

    private ListView listView;
    private ListViewAdapterFantasy adapter;
    private DatabaseHelperFantasy databaseHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseHelper = new DatabaseHelperFantasy(this);
    ...
    public void reloadingDatabase() {
        ...
        adapter = new ListViewAdapterFantasy(this, R.layout.book_item, bookList, databaseHelper);
