...
public class ScienceActivity extends AppCompatActivity {
    ...
    private ListViewAdapterScience adapter;
    private DatabaseHelperScience databaseHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseHelper = new DatabaseHelperScience(this);
    ...
    public void reloadingDatabase() {
        ...
        adapter = new ListViewAdapterScience(this, R.layout.book_item, bookList, databaseHelper);
        listView.setAdapter(adapter);
    }

    private void addingNewFriendDialog() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(ScienceActivity.this);
