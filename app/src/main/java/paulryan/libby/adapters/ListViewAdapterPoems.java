...
public class ListViewAdapterPoems extends ArrayAdapter<Book> {
    ...
    private PoemsActivity activity;
    private DatabaseHelperPoems databaseHelperPoems;
    private List<Book> bookList;

    public ListViewAdapterPoems (PoemsActivity context, int resource, List<Book> objects, DatabaseHelperPoems helper) {
        super(context, resource, objects);
        this.activity = context;
        this.databaseHelperPoems = helper;
