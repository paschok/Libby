...
public class ListViewAdapterDetectives extends ArrayAdapter<Book> {

    private DetectivesActivity activity;
    private DatabaseHelperDetectives databaseHelperDetectives;
    private List<Book> bookList;

    public ListViewAdapterDetectives(DetectivesActivity context, int resource, List<Book> objects, DatabaseHelperDetectives helper) {
        super(context, resource, objects);
        this.activity = context;
        this.databaseHelperDetectives = helper;
