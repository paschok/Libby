...
public class ListViewAdapterSciFi extends ArrayAdapter<Book> {

    private SciFiActivity activity;
    private DatabaseHelperSciFi databaseHelperSciFi;
    private List<Book> bookList;

    public ListViewAdapterSciFi(SciFiActivity context, int resource, List<Book> objects, DatabaseHelperSciFi helper) {
        super(context, resource, objects);
        this.activity = context;
        this.databaseHelperSciFi = helper;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                databaseHelperSciFi.deleteFriend(getItem(position)); //delete in db
            ...
            public void onClick(View view) {
                ...
                alertDialog.setPositiveButton(R.string.dialog_OK, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        databaseHelperSciFi.updateFriend(book); //update to db
