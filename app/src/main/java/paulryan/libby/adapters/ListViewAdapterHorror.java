...
public class ListViewAdapterHorror extends ArrayAdapter<Book> {
    ...
    private HorrorActivity activity;
    private DatabaseHelperHorror databaseHelperDetectives;
    private List<Book> bookList;

    public ListViewAdapterHorror (HorrorActivity context, int resource, List<Book> objects, DatabaseHelperHorror helper) {
