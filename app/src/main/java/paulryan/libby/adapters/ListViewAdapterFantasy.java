...
import paulryan.libby.database.DatabaseHelperFantasy;

public class ListViewAdapterFantasy extends ArrayAdapter<Book> {

    private FantasyActivity activity;
    private DatabaseHelperFantasy databaseHelperFantasy;
    private List<Book> bookList;

    public ListViewAdapterFantasy(FantasyActivity context, int resource, List<Book> objects, DatabaseHelperFantasy helper) {
        super(context, resource, objects);
        this.activity = context;
        this.databaseHelperFantasy = helper;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                databaseHelperFantasy.deleteFriend(getItem(position)); //delete in db
            ...
            public void onClick(View view) {
                ...
                alertDialog.setPositiveButton(R.string.dialog_OK, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        databaseHelperFantasy.updateFriend(book); //update to db
