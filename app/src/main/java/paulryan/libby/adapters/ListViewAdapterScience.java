...
public class ListViewAdapterScience extends ArrayAdapter<Book> {

    private ScienceActivity activity;
    private DatabaseHelperScience databaseHelperScience;
    private List<Book> bookList;

    public ListViewAdapterScience(ScienceActivity context, int resource, List<Book> objects, DatabaseHelperScience helper) {
        super(context, resource, objects);
        this.activity = context;
        this.databaseHelperScience = helper;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                databaseHelperScience.deleteFriend(getItem(position)); //delete in db
            ...
            public void onClick(View view) {
                ...
                alertDialog.setPositiveButton(R.string.dialog_OK, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        databaseHelperScience.updateFriend(book); //update to db
