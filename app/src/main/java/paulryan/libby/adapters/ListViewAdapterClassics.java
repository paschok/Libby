...
public class ListViewAdapterClassics extends ArrayAdapter<Book> {

    private ClassicsActivity activity;
    private DatabaseHelperClassics databaseHelper;
    private List<Book> bookList;

    public ListViewAdapterClassics(ClassicsActivity context, int resource, List<Book> objects, DatabaseHelperClassics helper) {
