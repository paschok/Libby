...
public class DatabaseHelperDetectives extends SQLiteOpenHelper {

    private static final int DATABASE_VERSION = 1;
    private static final String DATABASE_BOOKS_ADVENTURES = "myDetectiveDB";

    // Book table name
    private static final String TABLE_ADVENTURES = "detective_books";
    ...
    public DatabaseHelperDetectives(Context context) {
