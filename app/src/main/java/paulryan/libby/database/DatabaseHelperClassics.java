...
public class DatabaseHelperClassics extends SQLiteOpenHelper {

    private static final int DATABASE_VERSION = 4;
    private static final String DATABASE_BOOKS_ADVENTURES = "myClassicsDB";

    // Book table name
    private static final String TABLE_ADVENTURES = "friend";
    ...
    public DatabaseHelperClassics(Context context) {
