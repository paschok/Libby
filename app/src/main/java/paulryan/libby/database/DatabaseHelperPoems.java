...
public class DatabaseHelperPoems extends SQLiteOpenHelper {

    private static final int DATABASE_VERSION = 1;
    private static final String DATABASE_BOOKS_ADVENTURES = "myPomsDB";

    // Book table name
    private static final String TABLE_ADVENTURES = "poem_books";
    ...
    public DatabaseHelperPoems (Context context) {
