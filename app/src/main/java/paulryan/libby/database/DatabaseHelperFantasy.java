...
public class DatabaseHelperFantasy extends SQLiteOpenHelper {

    private static final int DATABASE_VERSION = 1;
    private static final String DATABASE_BOOKS_ADVENTURES = "myFantasyDB";

    // Book table name
    private static final String TABLE_ADVENTURES = "fantasy_books";
    ...
    public DatabaseHelperFantasy(Context context) {
