...
public class DatabaseHelperAdventures extends SQLiteOpenHelper {

    private static final int DATABASE_VERSION = 3;
    private static final String DATABASE_BOOKS_ADVENTURES = "myLibbyDB";

    // Book table name
    private static final String TABLE_ADVENTURES = "adventure_books";
    ...
    public DatabaseHelperAdventures(Context context) {
