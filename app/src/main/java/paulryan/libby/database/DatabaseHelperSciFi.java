...
public class DatabaseHelperSciFi extends SQLiteOpenHelper {

    private static final int DATABASE_VERSION = 1;
    private static final String DATABASE_BOOKS_ADVENTURES = "mySciFiDB";

    // Book table name
    private static final String TABLE_ADVENTURES = "sci_fi_books";
    ...
    public DatabaseHelperSciFi(Context context) {
